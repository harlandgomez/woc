<%@ WebHandler Language="C#" Class="AutocompleteAdhoc"  Debug ="true"%>
using System;
using System.Web;
...
public class AutocompleteAdhoc : IHttpHandler
{
    public void ProcessRequest (HttpContext context) 
    {
        ...
        using (SqlConnection conn = new SqlConnection(UtilityService.Connection()))
        {
            if (category != "Select")
            {
                ...
                sql = "Select  Distinct " + category + "  FROM dbo.Adhoc INNER JOIN Agent ON Adhoc.AgentID = Agent.AgentID"; 
