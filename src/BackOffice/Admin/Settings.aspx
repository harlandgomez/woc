<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Settings.aspx.cs" Inherits="WOC.Book.Admin.Settings" MasterPageFile="~/Admin/Admin.Master" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
   ...
   <div id="tabs">
             ...
             <ul>
				...
				<li><a href="#tabs-2">Update Staff</a></li>
                <li><a href="#tabs-3">All Staff List </a></li>
            ...
            <tr>
               ...
               <tr>
                <td class="style19">
                    Country</td>
                <td class="style20">
                    <asp:DropDownList ID="ddlCountry" runat="server" Height="25px" Width="228px">
                    </asp:DropDownList>
                </td>
                <td class="style21">
                    </td>
               ...
               <tr>
                <td class="style27">
                    Password</td>
                <td class="style28">
                    <asp:TextBox ID="txtPassword" runat="server" Height="21px" TextMode="Password" 
               ...
               <tr>
                ...
                <td class="style22">
                    <asp:TextBox ID="txtRePassword" runat="server" Height="21px" 
                        TextMode="Password" Width="222px"></asp:TextBox>
      ...
      <table style="width:100%;">
            ...
            <tr>
               ...
               <tr>
                <td class="style19">
                    Country</td>
                <td class="style20">
                    <asp:DropDownList ID="ddlEditCountry" runat="server" Height="25px" 
                        Width="228px">
                    </asp:DropDownList>
                </td>
                <td class="style21">
            ...
            <tr>
                <td class="style27">
                    Password</td>
                <td class="style28">
                    <asp:TextBox ID="txtEditPassword" runat="server" Height="21px" TextMode="Password" 
                        width="222px"></asp:TextBox>
               ...
               <tr>
                <td class="style18">
                    Re-enter Password</td>
                <td class="style22">
                    <asp:TextBox ID="txtEditRePassword" runat="server" Height="21px" 
                        TextMode="Password" Width="222px"></asp:TextBox>
