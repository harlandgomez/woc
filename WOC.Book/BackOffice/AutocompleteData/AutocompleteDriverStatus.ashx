<%@ WebHandler Language="C#" Class="AutocompleteDriverStatus"  Debug ="true"%>
using System;
using System.Web;
...
public class AutocompleteDriverStatus : IHttpHandler
{
    public void ProcessRequest (HttpContext context) 
    {
        ...
        {
            sql = "Select Distinct " + category + " from OperationDetail";
